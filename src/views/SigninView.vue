      ...
      <form @submit.prevent="handleSubmit">
        ...
        <div class="formGroup">
          ...
          <input type="password" id="password" v-model="password" class="formField"
                 ...
                 required />      
          <div class="errorMessage" v-if="passwordErrorMsg">{{ passwordErrorMsg }}</div>            
        </div>
        <div class="formGroup">
...
const validatePassword = () => {
    if (password.value === "") {
      ...
      passwordErrorMsg.value = "Password must contain at least one lowercase letter, one uppercase letter, and one number";
    } else {
