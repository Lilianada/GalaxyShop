...
//       localStorage.setItem(("email", email),( password, "password"), (displayName, "displayName"));
...
//       state.password = "";
//       state.displayName = "";
//       localStorage.removeItem("email", "password", "displayName");
//       alert("You are logged out!");
//     },
//     initializeStore(state) {
//       if (localStorage.getItem("email", "password", "displayName")) {
